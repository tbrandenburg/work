...
describe('Schema Commands Branch Coverage', () => {
  ...
  describe('Schema Kinds Command', () => {
    it('should trigger context argument branch', async () => {
      const { default: SchemaKinds } =
        await import('../../../../../src/cli/commands/schema/kinds.js');
    ...
    it('should trigger error handling branch', async () => {
      ...
      await expect(command.run()).rejects.toThrow(
        'Failed to get kinds: Kinds failed'
      );
    });
  });
  ...
  describe('Schema Attrs Command', () => {
    it('should trigger context argument branch', async () => {
      const { default: SchemaAttrs } =
        await import('../../../../../src/cli/commands/schema/attrs.js');
    ...
    it('should trigger error handling branch', async () => {
      ...
      await expect(command.run()).rejects.toThrow(
        'Failed to get attributes: Attrs failed'
      );
    });
  });
  ...
  describe('Schema Relations Command', () => {
    it('should trigger context argument branch', async () => {
      const { default: SchemaRelations } =
        await import('../../../../../src/cli/commands/schema/relations.js');
    ...
    it('should trigger error handling branch', async () => {
      ...
      mockEngine.getRelationTypes.mockRejectedValue(
        new Error('Relations failed')
      );
      ...
      await expect(command.run()).rejects.toThrow(
        'Failed to get relation types: Relations failed'
      );
    });
  });
});
