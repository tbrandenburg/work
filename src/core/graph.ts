 ...
 */
export function validateRelation(relation: Relation, workItems: WorkItem[]): void {
 ...
 */
export function detectCycles(relations: Relation[], newRelation?: Relation): boolean {
 ...
 */
export function buildGraphSlice(workItems: WorkItem[], relations: Relation[]): {
  items: WorkItem[];
  relations: Relation[];
} {
 ...
 */
export function getRelatedItems(workItemId: string, workItems: WorkItem[], relations: Relation[]): WorkItem[] {
